...
class PaymentService {
    static async createDonate(organizerPayPalEmail, donationAmount) {
        ...
        request.requestBody({
            ...
            application_context: {
                return_url: `http://${process.env.BHOST}:3000/api/payment/return`,
                cancel_url: `http://${process.env.BHOST}:3000/api/payment/cancel`
            }
        });
    ...
    static async createAttend(orgnaizerPayPalEmail, totalAmount, platformFeePercentage) {
            ...
            purchase_units: [{
                ...
                payment_instruction: {
                    ...
                    platform_fees: [{
                        ...
                        payee: {
                            email_address: 'sb-oldiz31257457@business.example.com',
                        }
                    }]
                },
            }],
    ...
    static async successHandle(token)
    {
        return new paypal.orders.OrdersCaptureRequest(token);
    }
